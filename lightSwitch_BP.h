...
#include "lightSwitch_BP.generated.h"

UCLASS()
class MOD_1GAME_API AlightSwitch_BP : public AActor
{
	GENERATED_BODY()
...
public:	
	...
	/* Called When Something Enters Sphere Comp*/
	...
	/*Called When Something Leaves Sphere Comp*/
	UFUNCTION(BlueprintNativeEvent, Category= "SwitchFunctions")
	...
	void OnOverlapEnd_Implementation(class UPrimitiveComponent* OverlappedComp, class AActor* OtherActor, class UPrimitiveComponent* OtherComp,
					  int32 OtherBodyIndex);
	//toggles light intensity
	UFUNCTION()
	void ToggleLight();

	//Desired Intensity for the light comp
